...
TalkToTrainer::
    ...
    ; AndrewNote - Offer rematch after end battle text
    CheckEvent EVENT_NO_REMATCH_OPTION ; AndrewNote - some trainers don't offer rematch
    jr nz, .noRematch
    call RematchChoice
...
.noRematch
    jp TextScriptEnd
.rematch
    SetEvent EVENT_REMATCH ; AndrewNote - set event to reduce exp gain
    jr .trainerNotYetFought
.trainerNotYetFought
	ld a, $4
