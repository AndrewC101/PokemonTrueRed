...
MissableObjectIDs_6219b:
	...
	;db HS_SAFFRON_CITY_2 ; AndrewNote - don't remove guy blocking hall of destiny
	...
	;db HS_SAFFRON_CITY_F ; AndrewNote - don't remove guy blocking hall of destiny
	db HS_SILPH_CO_2F_2
	db HS_SILPH_CO_2F_3
	db HS_SILPH_CO_2F_4
	db HS_SILPH_CO_2F_5
...
SilphCo11Text4:
	text_asm
	SetEvent EVENT_MEDIUM_STAT_EXP ; AndrewNote - Rocket CEO should be strong
