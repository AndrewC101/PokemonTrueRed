...
PokemonTower7Script2:
	...
	ld [wPokemonTower7FCurScript], a
	ld [wCurMapScript], a
	ResetEvent EVENT_NO_REMATCH_OPTION ; AndrewNote - enable rematches after rocket leaves
	ret
...
PokemonTower7Text1:
	text_asm
	SetEvent EVENT_NO_REMATCH_OPTION ; AndrewNote - rocket talks to player after victory, so disable rematch option
