...
.asm_515ff
	...
	; AndrewNote - deleted code that would despawn Aizen
	ld a, HS_BILL_1
	ld [wMissableObjectIndex], a
	predef HideObject
	ld a, HS_BILL_2
...
Route25TrainerHeader4:
	trainer EVENT_BEAT_ROUTE_25_TRAINER_4, 0, Route25BattleText5, Route25EndBattleText5, Route25AfterBattleText5
