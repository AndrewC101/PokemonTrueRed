...
VictoryRoad3Text3:
	text_asm
    SetEvent EVENT_BONUS_MONEY ; AndrewNote - this trainer is used for grinding money pre Elite 4
...
VictoryRoad3Text4:
	text_asm
	predef HealParty ; AndrewNote - heal party as this trainer is for level grinding pre Elite 4
