...
; AndrewNote - add new trainer
RockTunnel1TrainerHeader7:
	trainer EVENT_BEAT_ROCK_TUNNEL_1_TRAINER_7, 0, RockTunnel1BattleText8, RockTunnel1EndBattleText8, RockTunnel1AfterBattleText8
	db -1 ; end
...
RockTunnel1BattleText8:
	text_far _RockTunnel1BattleText8
	text_end
