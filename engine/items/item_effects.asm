...
; The Master Ball always succeeds.
    ...
    ; AndrewNote - 15/16 chance for mewtwo to block masterball
	call Random
	cp 16
	jp c, .captured

    ld hl, MewtwoBlockedBallText
    call PrintText
    ret
...
.useVitamin
	...
	inc h
.noCarry2
	CheckEvent EVENT_BEAT_ELITE_4 ; AndrewNote - remove vitamin limit after E4, taken from shinpokered
	jr z, .e4notbeaten
	ld a, 10
	ld b, a
...
MewtwoBlockedBallText:
	text_far _MewtwoBlockedBallText
	text_end
