...
.sleepEffect
	...
	ld a, [de]
	ld b, a
	and $5 ; AndrewNote - reduce max sleep turns to 5
...
; AndrewNote - reworked to reduce max sleep turns to 5
	call BattleRandom
	cp $0
	jr z, .setSleepCounter
	cp $5
	jr nc, .setSleepCounter
	ld [de], a
...
.freeze1
    ...
    ; AndrewNote - PSYBLAST turns enemy to stone
	ld a, [wPlayerMoveNum]
    cp PSYWAVE
    jr nz, .normalFreeze
...
; hyper beam bits aren't reseted for opponent's side
    ...
    ; AndrewNote - PSYBLAST turns enemy stone
	ld a, [wEnemyMoveNum]
    cp PSYWAVE
    jr nz, .normalFreeze
...
StatModifierDownEffect:
	...
	; AndrewNote - enemies don't have 25% chance for status moves to miss
	;ld a, [wLinkState]
	;cp LINK_STATE_BATTLING
	;jr .statModifierDownEffect
	;call BattleRandom
