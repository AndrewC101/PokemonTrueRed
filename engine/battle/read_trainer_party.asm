...
; AndrewNote - basically everything below is not used
;.AddLoneMove
; does the trainer have a single monster with a different move?
; I have commented this out - don't want special moves
...
; I have kept this here but commented it out - don't want special moves on rival
; pidgeot
;	ld a, SKY_ATTACK
