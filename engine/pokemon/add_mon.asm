...
; Not wild.
    CheckEvent EVENT_BEAT_ELITE_4 ; AndrewNote - max DVs after E4 - also see core.asm L6210
    jr z, .randomDV

	call Random ; generate random IVs
	or $FF ; pokemon obtained by player have max DVs
	ld b, a
	call Random
	or $FF ; pokemon obtained by player have max DVs
	jr .next4
...
.randomDV
    call Random ; generate random IVs ; AndrewNote - good DVs for mon given to player eg starter
    or $90 ; pokemon given to player have above average DVs at worst
	ld b, a
	call Random
	or $90 ; pokemon given to player have above average DVs at worst
