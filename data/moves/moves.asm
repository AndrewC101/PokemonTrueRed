...
; Characteristics of each move.
	...
	; AndrewNote - make karate chop fighting type
	...
	; AndrewNote - make mega punch slightly more accurate
	...
	; AndrewNote - horn drill is now Photon Wave
	move HORN_DRILL,   PARALYZE_SIDE_EFFECT2,       80, PSYCHIC_TYPE, 100,  15
	...
	; AndrewNote - increase hydropump accuracy to blizzard level
	...
	; AndrewNote - increase to 100 accuracy but decrease power to 140
	move HYPER_BEAM,   HYPER_BEAM_EFFECT,          140, NORMAL,        100,  5
	move PECK,         NO_ADDITIONAL_EFFECT,        35, FLYING,       100, 35
	move DRILL_PECK,   NO_ADDITIONAL_EFFECT,        80, FLYING,       100, 20
	; AndrewNote - increase to 100 accuracy and remove recoil, because it's the only real fighting move
	...
	; AndrewNote - increase power to 60
	move MEGA_DRAIN,   DRAIN_HP_EFFECT,             60, GRASS,        100, 10
	move LEECH_SEED,   LEECH_SEED_EFFECT,            0, GRASS,         90, 10
	move GROWTH,       SPECIAL_UP1_EFFECT,           0, NORMAL,       100, 40
	move RAZOR_LEAF,   NO_ADDITIONAL_EFFECT,        55, GRASS,         95, 25
	; AndrewNote - make single turn to be in line with FireBlast, Blizzard, Thunder
	move SOLARBEAM,    NO_ADDITIONAL_EFFECT,        120, GRASS,        90, 10
	move POISONPOWDER, POISON_EFFECT,                0, POISON,        75, 35
	; AndrewNote - increase accuracy to 100 same as thunderwave
	move STUN_SPORE,   PARALYZE_EFFECT,              0, NORMAL,         100, 20
	...
	; AndrewNote - now a true 90 bp move, as this is the only dragon move
	move DRAGON_RAGE,  BURN_SIDE_EFFECT1,           90, DRAGON,       100, 15
	...
	; AndrewNote - Fissue is now PsyCrush
	move FISSURE,      PARALYZE_SIDE_EFFECT1,        120, ROCK,        100,  20
	; AndrewNote - decrease to 80 power, dig is too strong
	...
	move RAGE,         NO_ADDITIONAL_EFFECT,        60, NORMAL,       100, 20
	...
	; AndrewNote - now increases defense as evasion is BS
	move DOUBLE_TEAM,  DEFENSE_UP1_EFFECT,           0, NORMAL,       100, 15
	move RECOVER,      HEAL_EFFECT,                  0, DRAGON,       100, 20
	move HARDEN,       DEFENSE_UP1_EFFECT,           0, NORMAL,       100, 30
	; AndrewNote - now increases defense as evasion is BS
	move MINIMIZE,     DEFENSE_UP1_EFFECT,           0, NORMAL,       100, 20
	...
	; AndrewNote - now single turn and 90 power, since this is the best flying move
	...
	; AndrewNote - increase to 200 power
	...
	; AndrewNote - increase to 100 accuracy as this is the best rock move
	move ROCK_SLIDE,   NO_ADDITIONAL_EFFECT,        80, ROCK,          100, 10
