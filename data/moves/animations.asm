...
GuillotineAnim:
	battle_anim GUILLOTINE, SE_DARK_SCREEN_PALETTE
    battle_anim NO_MOVE, SE_DARK_SCREEN_FLASH
    battle_anim NO_MOVE, SUBANIM_2B, 1, 6
    battle_anim NO_MOVE, SE_DARK_SCREEN_FLASH
    battle_anim GUILLOTINE, SUBANIM_29, 1, 2
    battle_anim NO_MOVE, SE_RESET_SCREEN_PALETTE
	db -1 ; end
...
HornDrillAnim:
	...
	battle_anim HORN_DRILL, SUBANIM_33, 1, 6
	battle_anim HORN_DRILL, SUBANIM_33, 1, 6
	battle_anim NO_MOVE, SE_RESET_SCREEN_PALETTE
	db -1 ; end
...
FissureAnim:
	battle_anim FISSURE, SE_DARK_SCREEN_PALETTE
...
PsywaveAnim:
	battle_anim PSYWAVE, SE_DARK_SCREEN_PALETTE
	battle_anim PSYWAVE, SUBANIM_2E, 0, 6
    battle_anim NO_MOVE, SUBANIM_01, 0, 6
    battle_anim NO_MOVE, SE_RESET_SCREEN_PALETTE
    db -1 ; end
