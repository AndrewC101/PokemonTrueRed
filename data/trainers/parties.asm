...
; Rock Tunnel B1F
	...
	db 35, GENGAR, 0
; Victory Road 2F
	db 58, ARCANINE, LAPRAS, SNORLAX, 0
; Rock Tunnel 1F
...
GiovanniData:
	...
	db $FF, 54, AERODACTYL, 55, MACHAMP, 56, GYARADOS, 57, SNORLAX, 58, RHYDON, 0
...
BrunoData:
	db $FF, 63, TAUROS, 64, GOLEM, 65, PINSIR, 66, RHYDON, 66, SNORLAX, 67, MACHAMP, 0
    db 100, TAUROS, GOLEM, PINSIR, RHYDON, SNORLAX, MACHAMP, 0

BrockData:
	db $FF, 15, ONIX, 17, RHYHORN, 0
...
ErikaData:
	db $FF, 50, VILEPLUME, 50, VICTREEBEL, 51, EXEGGUTOR, 52, VENUSAUR, 0
	db $FF, 84, VILEPLUME, 84, VICTREEBEL, 85, PARASECT, 86, TANGELA, 87, EXEGGUTOR, 88, VENUSAUR, 0

KogaData:
	db $FF, 52, SCYTHER, 53, NIDOKING, 54, GENGAR, 54, HYPNO, 55, PINSIR, 0
	db $FF, 88, SCYTHER, 89, NIDOKING, 90, GENGAR, 90, HYPNO, 91, KANGASKHAN, 92, PINSIR, 0

BlaineData:
	db $FF, 58, MAGMAR, 58, NINETALES, 59, ARCANINE, 59, CHARIZARD, 60, MOLTRES, 0
	db $FF, 96, MAGMAR, 97, FLAREON, 98, NINETALES, 98, ARCANINE, 99, CHARIZARD, 100, MOLTRES, 0

SabrinaData:
	db $FF, 56, JYNX, 56, SLOWBRO, 57, EXEGGUTOR, 57, STARMIE, 58, ALAKAZAM, 0
...
; Silph Co. 7F
	db $FF, 54, NIDOKING, 55, EXEGGUTOR, 56, CHANSEY, 56, STARMIE, 57, ALAKAZAM, 58, BLASTOISE, 0
	db $FF, 54, NIDOKING, 55, EXEGGUTOR, 56, CHANSEY, 56, STARMIE, 57, ALAKAZAM, 58, VENUSAUR, 0
	db $FF, 54, NIDOKING, 55, EXEGGUTOR, 56, CHANSEY, 56, STARMIE, 57, ALAKAZAM, 58, CHARIZARD, 0
; Route 22
