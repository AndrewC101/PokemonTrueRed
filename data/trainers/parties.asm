...
; Yuna
    db $FF, 78, PIDGEOT, 79, ARCANINE, 80, RAPIDASH, 81, JYNX, 81, SANDSLASH, 82, DRAGONITE, 0
...
; YUFFIE
	db 50, SANDSLASH, PINSIR, PERSIAN, 0
; Route 9
...
; Green
    db $FF, 72, CLEFABLE, 73, GENGAR, 74, VICTREEBEL, 75, NINETALES, 76, KANGASKHAN, 77, BLASTOISE, 0
...
; Route 10
	db 34, RHYHORN, CLOYSTER, 0
	db 35, DUGTRIO, RAICHU, 0
; Rock Tunnel B1F
...
; Trunks
    db $FF, 68, FEAROW, 69, RAICHU, 70, ARCANINE, 71, MACHAMP, 72, MAROWAK, 73, ELECTABUZZ, 0
...
; Officer Jenny
    db 50, ARCANINE, BLASTOISE, PIDGEOT, 0
