...
; James
    db $FF, 140, PERSIAN, 140, SCYTHER, 140, GENGAR, 140, SLOWBRO, 140, SNORLAX, 140, ALAKAZAM, 0
...
; Trunks
    db $FF, 75, PIDGEOT, 76, JOLTEON, 77, ARCANINE, 78, MACHAMP, 79, TAUROS, 80, ELECTABUZZ, 0
...
; Cinnabar Lab Head
    db $FF, 100, MEW, 100, PORYGON, 100, MEW, 100, DRAGONITE, 100, MEW, 200, DITTO, 0
