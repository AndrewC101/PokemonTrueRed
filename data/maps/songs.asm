MapSongBanks::
	...
	; AndrewNote - play IndigoPlateau at SS Anne Bow
	db MUSIC_INDIGO_PLATEAU, BANK(Music_IndigoPlateau) ; SS_ANNE_BOW
	...
	; AndrewNote - play IndigoPlateau in fighting dojo
	db MUSIC_INDIGO_PLATEAU, BANK(Music_IndigoPlateau) ; FIGHTING_DOJO
