SaffronCity_Object:
	...
	; AndrewNote - add guy blocking hall of destiny
	object_event 26, 4, SPRITE_GENTLEMAN, STAY, DOWN, 2 ; person
	...
	object_event 27,  4, SPRITE_ERIKA, STAY, DOWN, 13 ; person
	object_event 18, 22, SPRITE_ROCKET, STAY, DOWN, 14 ; person
	; AndrewNote - add another guy blocking hall of destiny
	object_event 26, 4, SPRITE_GENTLEMAN, STAY, DOWN, 15 ; person
