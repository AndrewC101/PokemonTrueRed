...
CeladonMart2Clerk2Text::
	script_mart TM_BODY_SLAM, TM_ROCK_SLIDE, TM_EARTHQUAKE, TM_SKY_ATTACK, TM_SELFDESTRUCT, TM_SUBMISSION, TM_SEISMIC_TOSS, TM_REFLECT
...
IndigoCashierText::
	script_mart ULTRA_BALL, PP_UP, EXP_ALL, MAX_REVIVE, MAX_ELIXER, FULL_RESTORE, REVIVE, MAX_POTION, ETHER, FULL_HEAL, MAX_REPEL
