...
; Pallet Town events
	...
	const EVENT_GOOD_DVS ; AndrewNote - at least 10 DVs for one time pokemon pre Elite 4
	const EVENT_AI_JUST_SWITCHED
	const EVENT_HALL_OF_FAME_DEX_RATING
	const EVENT_MAX_STAT_EXP ; AndrewNote - 655 stat exp per level for Elite 4 and optional bosses
	const EVENT_MEDIUM_STAT_EXP ; AndrewNote - 324 stat exp per level for gym leaders and rival
	const EVENT_PALLET_AFTER_GETTING_POKEBALLS
	const EVENT_BONUS_MONEY ; AndrewNote - x2 money for Elite 4
	const EVENT_BIG_BONUS_MONEY ; AndrewNote - x10 money for optional bosses
	const EVENT_MAX_BONUS_MONEY ; AndrewNote - x100 money for Master Oak
	const EVENT_NO_ITEMS ; AndrewNote - no items during battle
	const EVENT_NO_SHIFT ; AndrewNote - no shift during battle
	const EVENT_ENEMY_MOVE_FIRST ; AndrewNote - used for enemy switching
	...
	const EVENT_REMATCH ; AndrewNote - denote a rematch to lower exp gained
	const_skip 4
...
; Pewter City events
	...
	const EVENT_BEAT_IVY
	const EVENT_BEAT_ICHIGO
	const_skip 6
...
; Saffron City events
	...
	; AndrewNote - add a bunch of fightingDojo trainers, not all are used
	; in fact they can't be, the game can't render more than 10 objects at once
	...
	const EVENT_BEAT_FIGHTING_DOJO_TRAINER_5
	const EVENT_BEAT_FIGHTING_DOJO_TRAINER_6
	const EVENT_BEAT_FIGHTING_DOJO_TRAINER_7
	const EVENT_BEAT_FIGHTING_DOJO_TRAINER_8
	const EVENT_BEAT_FIGHTING_DOJO_TRAINER_9
	const EVENT_BEAT_FIGHTING_DOJO_TRAINER_10
	const EVENT_BEAT_FIGHTING_DOJO_TRAINER_11
...
; Route 10 events
	...
	const EVENT_BEAT_ROCK_TUNNEL_1_TRAINER_7 ; AndrewNote - new trainer, Chris Chan
...
; S.S. Anne events
	const_next $5C0
	const_skip 4
	; SS Anne optional bosses defeated flags
	const EVENT_BEAT_BROCK_REMATCH
	const EVENT_BEAT_MISTY_REMATCH
	const EVENT_BEAT_SURGE_REMATCH
	...
	const EVENT_BEAT_LORELEI_REMATCH
	const EVENT_BEAT_BRUNO_REMATCH
	const EVENT_BEAT_CHRIS_CHAN_REMATCH
...
; Silph Co. events
	...
	const EVENT_BEAT_SILPH_CO_11F_TRAINER_2
	const_skip
...
; Indigo Plateau events
	...
	const EVENT_NO_REMATCH_OPTION ; AndrewNote - used when trainers shouldn't offer rematch, such as Elite 4
	const_skip 4
